...
updated_at: 2026-07-15T22:17:57Z
parent: mingo-y9gb
---
...
## Outcome: rejected and reverted (2026-07-16)

Dan: a corpus of autogenerated content under fake identities breaks the whole concept — the product's claim is that every post has a true story. Corpus wiped via regenesis (see the wipe bean). The seeder tooling stays in-repo for LOCAL/dev demos only; never against prod.
